...
export default defineType({
  ...
  fields: [
    ...
    defineField({ name: "starting_price", title: "Starting Price (₹)", type: "number", validation: (r) => r.required().min(0) }),
  ...
  preview: { select: { title: "name", subtitle: "category.name", media: "images.0" } },
});
